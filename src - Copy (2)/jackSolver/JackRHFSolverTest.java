...
public class JackRHFSolverTest {
	...
	public void testEstimateDenstiyMatrix() {
		...
		GaussianOrbital[] orbitals = GaussianOrbital.generateOrbitalArray(atoms,3);
	...
	/**
	 * Test method for {@link jackSolver.Integrals#calculate4centerintegrals(jackSolver.GaussianOrbital[])}.
	 */
	@Test
	public void testCalculate4centerintegrals() {
		...
		double[][][][] fourcenterintegrals = Integrals.calculate4centerintegrals(orbitals);
	...
	public void testCalculate4centerintegral() {
		...
		//=======================================================
		double fourci = Integrals.calculateFourCenterIntegral(orbitals[0].alpha[0], orbitals[0].alpha[0], orbitals[0].alpha[0], orbitals[0].alpha[0], 0, 0, 0);
		...
		fourci = Integrals.calculateFourCenterIntegral(orbitals[1].alpha[0], orbitals[1].alpha[0], orbitals[1].alpha[0], orbitals[1].alpha[0], 0, 0, 0);
	...
	public void testCalculate4centerintegralcontractedgaussianloop() {
		...
		int STOnG =3;  
		GaussianOrbital[] orbitals = GaussianOrbital.generateOrbitalArray(atoms,STOnG);
		double fourci = Integrals.calculateFourCenterIntegrals(orbitals,1,1,1,1);
	...
	/**
	 * Test method for {@link jackSolver.GaussianOrbital#generateOrbitalArray(Atom[] atoms)}.
	 */
	@Test
	...
	public void testcalcNewDensityMatrix() {
		...
		System.out.println(PMatrix);
		DoubleMatrix2D oldPMatrix = PMatrix.copy();
		...
		JackRHFSolver.calcNewDensityMatrix(PMatrix,oldPMatrix,CMatrix,2);
		System.out.println(PMatrix);
	...
	public void testHFSolver() {
		...
		double energy = JackRHFSolver.HFSolver(atoms,numberofelectrons,2);
		System.out.println(" energy: "+energy );
		System.out.println("energy should be: -2.86065870404886");
		assertTrue(Math.abs(energy+2.86065870404886)<=0.001);
	...
	public void test2HFSolver() {
		...
		double energy = JackRHFSolver.HFSolver(atoms2,numberofelectrons,2);
		System.out.println(" energy: "+energy );
		System.out.println("energy should be: -1.1140149480073371");
		assertTrue(Math.abs(energy+1.1140149480073371)<=0.001);
	...
	public void test3HFSolver(){
		...
		Atom atom1 = new Atom(0,0,1.463200,1);
		Atom atom2 = new Atom(0,0,0,2);
		Atom atom3 = new Atom(0,5,1,1);
		Atom atom4 = new Atom(0,5,0,1);
	...
	public void testH2GasTestHFSolver() {
		...
		int numberofelectrons =2*(x*y*z+1);
		System.out.println("number of electrons: "+numberofelectrons);
		System.out.println("Calculating gas energy");
		
		double energy = JackRHFSolver.HFSolver(atoms,numberofelectrons,1);
		System.out.println(" energy: "+energy );
	...
	private Atom[] generateH2Gas(int x, int y, int z) {
		...
		atoms[currentatom]=new Atom(-10,-10,-10,2);
		return atoms;
	}
	...
	@Test
	public void testExchangeColumnsofMatrix() {
		System.out.println("===================================================");
		System.out.println("========testExchangeColumnsofMatrix================");
		
		double[][] Smat = {{1,2,3},{4,5,6},{7,8,9}};
		System.out.println("===SMatrix===");
		DoubleMatrix2D SMatrix = new DenseDoubleMatrix2D(Smat);
		System.out.println(SMatrix);
		JackRHFSolver.exchangeColumnsOfMatrix(0,1,SMatrix);
		System.out.println("===SMatrix swapped===");
		System.out.println(SMatrix);
	...
	@Test
	public void testsortEigenvaluesAndVectors() {
		System.out.println("===================================================");
		System.out.println("========testsortEigenvaluesAndVectors================");
		
		
		
		
		System.out.println("===SdiagMatrix===");
		double[][] Smat = {{0.5429,0},{0,1.45077}};
		DoubleMatrix2D sdiagMatrix = new DenseDoubleMatrix2D(Smat);
		System.out.println(sdiagMatrix);
		System.out.println("===uMatrix===");
		double[][] umat =  {{1,2},{3,4}};
		DoubleMatrix2D uMatrix = new DenseDoubleMatrix2D(umat);
		System.out.println(uMatrix);
		
		JackRHFSolver.sortEigenvaluesAndVectors(sdiagMatrix,uMatrix);
		System.out.println("===SMatrix swapped===");
		System.out.println(sdiagMatrix);
		System.out.println(uMatrix);
		...
		@Test
		public void testsortEigenvaluesAndVectors2() {
			System.out.println("===================================================");
			System.out.println("========testsortEigenvaluesAndVectors================");
			
			
			System.out.println("===SdiagMatrix===");
			double[][] Smat = {{1,0,0},{0,2,0},{0,0,3}};
			DoubleMatrix2D sdiagMatrix = new DenseDoubleMatrix2D(Smat);
			System.out.println(sdiagMatrix);
			System.out.println("===uMatrix===");
			double[][] umat =  {{1,2,3},{4,5,6},{7,8,9}};
			DoubleMatrix2D uMatrix = new DenseDoubleMatrix2D(umat);
			System.out.println(uMatrix);
	...
	public void testCOLTv2cannonicalOrthogonalizationSolver() {
		...
		System.out.println("===SMatrix===");
		System.out.println(SMatrix);
		/*System.out.println("===XMatrix eigenvalue decomposition method===");
		DoubleMatrix2D XMatrix = cannonicalOrthogonalizationEVD(SMatrix);
		
		System.out.println(XMatrix);*/
		
		System.out.println("===XMatrix eigenvalue decomposition with sort method===");
		DoubleMatrix2D XMatrix = cannonicalOrthogonalizationEVDwithSort(SMatrix);
		
		System.out.println(XMatrix);
		/*
		System.out.println("===XMatrix Singular decomposition method===");
		XMatrix = cannonicalOrthogonalizationSVD(SMatrix);
		
		System.out.println(XMatrix);
		*/
		
		System.out.println("===XMatrix old from the book method===");
		XMatrix = cannonicalOrthogonalization(SMatrix);
	...
	public static DoubleMatrix2D cannonicalOrthogonalizationEVDwithSort(DoubleMatrix2D SMatrix) {
		//X=Us^-1/2
	...
	public static DoubleMatrix2D cannonicalOrthogonalizationSVD(DoubleMatrix2D SMatrix) {
		//X=Us^-1/2
				
		DoubleMatrix2D SadjointMatrix = JackRHFSolver.adjoint(SMatrix);
		SingularValueDecomposition svd = new SingularValueDecomposition(SadjointMatrix);  //A = U*S*V'
	...
	public static DoubleMatrix2D cannonicalOrthogonalization(DoubleMatrix2D SMatrix) {
		...
		DoubleMatrix2D SdiagMatrix = JackRHFSolver.diagonalize2x2MatrixgetEigenValues(SMatrix);
		DoubleMatrix2D UMatrix = JackRHFSolver.diagonalize2x2MatrixgetEigenVectors(SMatrix);
		System.out.println(SdiagMatrix);
		System.out.println(UMatrix);
