...
public class JackRHFSolverTest {
	...
	public void testcalcGMatrix() {
		...
		JackRHFSolver.calcGMatrix(GMatrix,PMatrix, orbitals);
		System.out.println(GMatrix);
	...
	public void testHFSolver() {
		System.out.println("=================================================================");
		System.out.println("========testHFSolver=============================================");
		...
		assertTrue(Math.abs(energy+2.86065870404886)<=0.0001);
		System.out.println("=================================================================");
		System.out.println("calculation RHF for H-H ");
		atom1 = new Atom(0,0,1.463200,1);
		atom2 = new Atom(0,0,0,1);
		//Atom atom3 = new Atom(0,2,2,1);
		//Atom atom4 = new Atom(0,2,3,1);
		...
		energy = JackRHFSolver.HFSolver(atoms2,numberofelectrons);
		System.out.println(" energy: "+energy );
